...
# En este Endpoint el agente solo puede ser consultado cuando se encuenten online en la plataforma, de otra forma repondera con un error
# Para mas opciones puede consultar la documentación
# https://api-doc.ccc.uno/?version=latest#e293feca-b399-4548-bccd-b4693562d1b3
...
url = 'https://api.ccc.uno/ws/Agent/getStatus'
